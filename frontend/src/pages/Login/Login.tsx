    ...
    return (
        <InitialPage title="Bem vindo a sua Web Wallet!">
            <form className="flex flex-col justify-center items-center">
                ...
                <button type="submit" onClick={handleLogin} className="mt-16.25 bg-[#ffe100] cursor-pointer border border-transparent
                rounded-[5px] p-1.25 w-42.5 h-8.75 hover:bg-[#000000]
                hover:text-[#ffe100] hover:border-[#ffe100]">Login</button>
